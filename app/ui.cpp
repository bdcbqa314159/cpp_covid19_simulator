...
// static void draw_person(cairo_t *cr, GtkWidget *widget, Person *p)
// {
//     double x = p->location.get_x() * WINDOW_X * 1. / X_LIMIT;
//     double y = p->location.get_y() * WINDOW_Y * 1. / Y_LIMIT;
...
// static void draw_history_bar(cairo_t *cr, GtkWidget *widget, int x, int total, int y)
// {
//     double gx = WINDOW_X + (x * WINDOW_X * 1. / total);
//     double gy = WINDOW_Y - (y * WINDOW_X * 1. / NUM_PEOPLE);
...
//     g_signal_connect(drawing_area, "configure-event", G_CALLBACK(activate), NULL);
//     gtk_widget_show_all(window);
//     clear_surface();
//     simmain();
// }

// void ui_redraw(Person *people, int numpeople, int *history, int history_length)
// {
//     clear_surface();
//     cairo_t *cr;
...
//         draw_history_bar(cr, drawing_area, i, history_length, history[i]);
